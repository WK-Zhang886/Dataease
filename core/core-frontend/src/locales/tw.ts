export default {
  ...
  online_map: {
    ...
    service_type: '服務類型',
    raster_tile_url: '柵格瓦片 URL',
    vector_style_json: '向量地圖 Style JSON',
    tile_url: '瓦片地址',
    tile_url_placeholder: '例如：http://localhost:18080/{z}/{x}/{y}.png',
    tile_url_tip: '支援標準 {z}/{x}/{y} URL 範本，可透過切片方案相容 TMS',
    style_url: 'Style JSON 地址',
    style_url_placeholder: '例如：http://localhost:18081/styles/basic-preview/style.json',
    style_url_tip: '請輸入完整的 MapLibre Style JSON 地址，內部瓦片、字型和圖示資源需允許跨域存取',
    tile_scheme: '切片方案',
    tile_size: '瓦片尺寸',
    min_zoom: '最小層級',
    max_zoom: '最大層級',
    zoom_tip: '限制地圖允許操作的縮放範圍，不會增加服務本身不存在的地圖細節',
    show_attribution: '顯示版權說明',
    attribution: '版權說明',
    raster_attribution_tip: '選填，留空時不顯示自訂版權說明',
    vector_attribution_tip: '選填，填寫後將取代 Style 資料來源原有的版權說明；留空則保留原說明',
    map_load_error: '地圖載入失敗，請檢查地址、跨域、資源完整性和網路設定',
    map_network_offline_error: '目前瀏覽器處於離線狀態，請恢復網路後重試',
    map_mixed_content_error:
      '目前頁面使用 HTTPS，瀏覽器已阻擋 HTTP 地圖資源，請將地圖服務切換為 HTTPS',
    map_localhost_error:
      '地圖地址使用 localhost，它指向目前訪問者的電腦；請確認本機服務已啟動，或改為瀏覽器可存取的伺服器地址',
    map_style_request_error: '無法存取 Style JSON，請檢查地址、網路連線或跨域設定',
    map_style_http_error: 'Style JSON 請求失敗（HTTP {status}），請檢查地址和服務狀態',
    map_style_json_error: 'Style JSON 內容不是有效的 JSON',
    map_style_format_error: 'Style JSON 格式不完整，必須包含 version 8、sources 和 layers',
    map_tile_http_error: '地圖瓦片請求失敗（HTTP {status}），請檢查地址範本、可用層級和服務狀態',
    map_tile_load_error: '地圖瓦片載入失敗，請檢查地址範本、可用層級和跨域設定',
    map_glyph_load_error: '地圖字型資源載入失敗，請檢查 glyphs 地址和跨域設定',
    map_sprite_load_error: '地圖圖示資源載入失敗，請檢查 sprite 地址和跨域設定',
    map_resource_http_error: '地圖資源請求失敗（HTTP {status}），請檢查 Style 中的資源地址',
    map_resource_load_error: '地圖資源載入失敗，請檢查 Style 中的資源地址和跨域設定'
  },
  setting_basic: {
